          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200/70 bg-white shadow-[0_10px_40px_rgba(15,23,42,0.08)] dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="grid grid-cols-1 border-t border-slate-100 bg-white/50 dark:border-slate-800 dark:bg-slate-900/50 md:grid-cols-3 sm:divide-x sm:divide-slate-100 sm:dark:divide-slate-800">
              <div className="p-6 sm:px-10 sm:py-8">
                <div className="mb-3">
                  <CalendarRange size={20} className="text-[#67b7dc] dark:text-sky-400" />
                </div>
              ...
              <div className="border-t border-slate-100 p-6 dark:border-slate-800 sm:border-t-0 sm:px-10 sm:py-8">
                <div className="mb-3">
                  <Building2 size={20} className="text-[#6771dc] dark:text-indigo-400" />
                </div>
      ...
      <div className="space-y-4 text-sm">
        ...
        {institutions ? (
          <div>
            ...
            <p className="mt-1 text-slate-600 dark:text-slate-300">{institutions}</p>
          </div>
        ) : null}
        <div>
...
function RelatedIaCard({ ia }: { ia: RelatedIa }) {
  ...
  return (
    <motion.div
      variants={{ hidden: { opacity: 0, y: 14 }, show: { opacity: 1, y: 0 } }}
      className="relative overflow-hidden rounded-xl border border-slate-200/80 bg-white p-5 pt-12 shadow-sm transition-shadow hover:shadow-md dark:border-slate-700 dark:bg-slate-900"
    >
